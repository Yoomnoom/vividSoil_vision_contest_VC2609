...
const STRINGS = {
  ...
  en: {
    ...
    regionAllOption: 'All',
    regionNoResults: 'No matching neighborhoods',
  ...
  ja: {
    ...
    datePickerToday: '今日',
    datePickerClear: 'クリア',
    datePickerPrevMonth: '前の月',
    datePickerNextMonth: '次の月',
    submitIdle: 'おすすめを見る',
